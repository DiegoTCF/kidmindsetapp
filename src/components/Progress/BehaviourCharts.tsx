  ...
  return <div className="relative" style={{
    ...
    height: size
      ...
      <svg className="transform -rotate-90" width={size} height={size}>
        ...
        <circle cx={size / 2} cy={size / 2} r={radius} stroke="#ff0066" strokeWidth={strokeWidth} fill="none" strokeDasharray={strokeDasharray} strokeLinecap="round" className="transition-all duration-500" />
      </svg>
...
const SmallCircularProgress = ({
  ...
  return <div className="relative" style={{
    ...
    height: size
      ...
      <svg className="transform -rotate-90" width={size} height={size}>
        <circle cx={size / 2} cy={size / 2} r={radius} stroke="hsl(var(--muted))" strokeWidth={strokeWidth} fill="none" />
        <circle cx={size / 2} cy={size / 2} r={radius} stroke="#ff0066" strokeWidth={strokeWidth} fill="none" strokeDasharray={strokeDasharray} strokeLinecap="round" className="transition-all duration-300" />
      </svg>
      <div className="absolute inset-0 flex items-center justify-center">
