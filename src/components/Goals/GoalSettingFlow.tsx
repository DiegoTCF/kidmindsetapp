...
const OUTCOME_GOALS = [
  ...
  'I want to win player of the season',
  'I want to play up an age group',
  'I want to get into the academy\'s first team',
  'I want to earn a professional contract',
  'I want to play at a higher level',
  'I want to be the top scorer',
  'I want to win a tournament or league title',
  'I want to get selected for trials'
];

const MINDSET_GOALS = [
  'I want to learn how to deal with ANTs',
  'I want to feel less nervous during matches',
  'I want to feel less nervous BEFORE matches',
  ...
  'I want to stay calm under pressure',
  'I want to trust my abilities',
  'I want to stop negative self-talk',
  'I want to be mentally stronger',
  'I want to enjoy playing more',
  'I want to handle coach feedback better',
...
export const GoalSettingFlow: React.FC = () => {
  ...
  const saveGoals = async () => {
    ...
    try {
      ...
      // Insert new goals
      const allGoals = [
        ...selectedOutcomeGoals.map(goal => ({ user_id: user.id, goal_type: 'outcome', goal_text: goal })),
        ...selectedMindsetGoals.map(goal => ({ user_id: user.id, goal_type: 'mindset', goal_text: goal })),
        ...selectedSkillGoals.map(goal => ({ user_id: user.id, goal_type: 'skill', goal_text: goal }))
      ];
  ...
  const getStepTitle = () => {
    switch (currentStep) {
      case 1: return "🏆 STEP 1 - What's your BIG dream this year?";
      case 2: return "🧠 STEP 2 - What do you want to get better at mentally?";
      case 3: return "⚽ STEP 3 - What do you want to improve on during matches / training?";
      case 4: return "✅ STEP 4 - Review Your Amazing Goals!";
      default: return "";
    }
  };
  ...
  const canProceed = () => {
    switch (currentStep) {
      case 1: return selectedOutcomeGoals.length > 0;
      case 2: return selectedMindsetGoals.length > 0;
      case 3: return selectedSkillGoals.length > 0;
      case 4: return true;
