        ...
        <CardContent className="space-y-6">
          <div className="space-y-3">
            ...
            <div className="space-y-4 mt-6">
              ...
              <div className="px-2">
                <Slider
                  value={[ratings[currentQuestion.key]]}
                  onValueChange={(value) => handleRatingChange(currentQuestion.key, value[0])}
                  max={10}
                  min={1}
                  step={1}
                  className={cn(
                    "transition-all duration-200",
                    `[&_.slider-range]:${getSliderColor(ratings[currentQuestion.key])}`
                  )}
                />
              </div>
