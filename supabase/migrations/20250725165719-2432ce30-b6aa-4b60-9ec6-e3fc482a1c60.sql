-- Fix Anonymous Access - Second Phase: Add auth.role() = 'authenticated' check to all policies

-- ============================================================================
-- ACTIVITIES TABLE - Add authenticated role check
-- ============================================================================
...
WITH CHECK (auth.role() = 'authenticated' AND child_id IN (
...
USING (auth.role() = 'authenticated' AND child_id IN (
...
-- ============================================================================
-- ADMIN_NOTIFICATIONS TABLE - Add authenticated role check
-- ============================================================================
...
-- ============================================================================
-- CHILDREN TABLE - Add authenticated role check
-- ============================================================================
...
FOR INSERT TO authenticated
WITH CHECK (auth.role() = 'authenticated' AND parent_id IN (
  SELECT parents.id FROM parents
  WHERE parents.user_id = auth.uid()
));
...
FOR UPDATE TO authenticated
USING (auth.role() = 'authenticated' AND parent_id IN (
  SELECT parents.id FROM parents
  WHERE parents.user_id = auth.uid()
));
...
-- ============================================================================
-- DAILY_TASKS TABLE - Add authenticated role check
-- ============================================================================
...
-- ============================================================================
-- GOALS TABLE - Add authenticated role check
-- ============================================================================
...
-- ============================================================================
-- PARENTS TABLE - Add authenticated role check
-- ============================================================================
...
-- ============================================================================
-- PROFILES TABLE - Add authenticated role check
-- ============================================================================
...
-- ============================================================================
-- PROGRESS_ENTRIES TABLE - Add authenticated role check
-- ============================================================================
...
-- ============================================================================
-- SUPER_BEHAVIOUR_RATINGS TABLE - Add authenticated role check
-- ============================================================================
...
-- ============================================================================
-- USER_ACTION_LOGS TABLE - Add authenticated role check
-- ============================================================================
...
-- ============================================================================
-- USER_ROLES TABLE - Add authenticated role check
-- ============================================================================
